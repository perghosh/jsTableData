...
export class CUITableText {
    ...
    */
    ...
    create_sections(eComponent, callback) {
        ...
        let append_section = (eComponent, sName, sClass) => {
            ...
            if (aSection.length === 2) { // found group name ?
                ...
                let eGroup = eComponent.querySelector("div[data-group='" + sGroup + "']");
    ...
    create_header(aHeader, callback) {
        ...
        let sHtml = CTableData.GetPropertyValue(this.m_oStyle, false, "html_header");
        if (!sHtml)
            sHtml = "span";
        else {
            let a = sHtml.split(".");
            ...
            */
                ...
                if (e.srcElement.dataset.input === "1") {
                    ...
                    if (oEdit.IsModified() === true) { // Is value modified
                        let bOk = true;
                        this.SetCellValue(oEdit.GetPositionRelative(), oEdit.GetValue(), { iReason: 1 /* Edit */, edit: oEdit });
