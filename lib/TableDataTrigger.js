...
export class CTableDataTrigger {
    constructor(options) {
        ...
        this.m_aTrigger = (new Array(23 /* LAST_EVENT */)).fill(true);
        this.m_acallTrigger = [];
        if (o.trigger)
    ...
    static SetTriggerName(aName) {
        if (CTableDataTrigger.s_aTriggerName.length === 0)
            CTableDataTrigger.s_aTriggerName = new Array(23 /* LAST_EVENT */);
    ...
    CELLSetValue(e, aArgument, _Row, _Column, value, bRaw) {
        let bReturn;
        bReturn = this.Trigger(this.Call([65543 /* BeforeSetValue */, 131080 /* AfterSetValue */]), e, aArgument, () => {
    ...
    ObserveResize(_1, bAdd) {
        ...
        if (!this.m_oRS) {
            this.m_oRS = new window.ResizeObserver((aE, oRS) => {
                ...
                for (let _e of aE) {
                    this.TriggerOn(this.Call([262160 /* OnResize */]), e, _e);
                }
            });
        }
