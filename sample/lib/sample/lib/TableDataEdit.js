...
(function (edit) {
    ...
    class CEditCheckbox extends CEdit {
        ...
        SetValue(_Value) {
            ...
            this.m_sOldValue = _Value;
            this.m_eElement.value = _Value || "1";
            let bCheck = _Value ? true : false;
            this.m_eElement.checked = bCheck;
        }
        IsModified() {
            if (this.m_iState & 2 /* Canceled */)
                return false;
    ...
    class CEditSelect extends CEdit {
        ...
        GetValueStack() { return [this.m_aPosition, this.m_aPositionRelative, this.GetValue(), this.m_OldValue]; }
        SetPosition(aPosition, aPositionRelative) {
            super.SetPosition(aPosition, aPositionRelative);
        }
        SetValue(_Value) {
...
//# sourceMappingURL=TableDataEdit.js.map
